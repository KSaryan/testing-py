...
def is_mel(name, email):
    """Is this user Mel?
        ...
        True
        >>> is_mel('Mel', 'notmel@ubermelon.com')
        True
    """
    name = name.lower()
    email = email.lower()
...
def most_and_least_common_type(treats):
    """Given list of treats, return most and least common treat types.
        ...
        >>> treat = [{'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'appetizer'}]
        >>> most_and_least_common_type(treat)
        ('drink', 'dessert')

        >>> treat = [{'type': 'appetizer'}, {'type': 'dessert'}, {'type': 'drink'}, {'type': 'drink'}, {'type': 'appetizer'}]
        >>> most_and_least_common_type(treat)
        ('drink', 'dessert')
        ...
        >>> treat = [{'type': 'dessert'}, {'type': 'dessert'}]
        >>> most_and_least_common_type(treat)
        ('dessert', 'dessert')
